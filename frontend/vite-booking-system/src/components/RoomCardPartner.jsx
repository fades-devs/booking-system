...
const RoomCardPartner = ({ room, onCancel }) => {
  ...
  const imgUrl =
    room.pictures && room.pictures.length > 0
      ? room.pictures[0]
      : "https://placehold.co/600x400?text=No%20Available%20Image";
        ...
        <form onSubmit={handleUpdate} className="flex flex-col gap-3">
          <div className="flex flex-col">
            ...
            <input
              ...
              className="border border-slate-300 rounded-md p-2 focus:outline-none focus:border-rose-400 transition-all"
            ></input>
          </div>
          <div className="flex flex-col">
            <label className="text-sm font-medium text-slate-600 mb-1">
          ...
          <div className="flex gap-2 mt-4">
            <button
              type="submit"
              className="bg-slate-900 text-white font-medium py-2 rounded-md grow hover:bg-slate-800 transition-all"
            >
              Save
            </button>
            <button
              ...
              className="bg-slate-200 text-slate-700 font-medium py-2 rounded-md grow hover:bg-slate-300 transition-all"
            >
              Cancel
            </button>
          </div>
        ...
        <div className="mt-auto flex flex-col gap-4">
          <div className="flex justify-between border-t border-slate-100 pt-3">
            <button
              ...
              className="text-sm font-medium text-slate-400 hover:text-rose-400 transition-all cursor-pointer"
            >
              Update
            </button>
            <button
