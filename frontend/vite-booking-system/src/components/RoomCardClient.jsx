      ...
      <div className="p-5 flex flex-col grow">
        ...
        <div className="mt-auto flex flex-col gap-4">
          <button
            ...
            className="w-full bg-slate-900 text-white font-medium py-2 rounded-md hover:bg-slate-800 hover:scale-102 transition-all cursor-pointer"
          >
            Book Room
          </button>
        </div>
